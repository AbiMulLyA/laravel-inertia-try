...
//#region resources/js/Pages/Settings/Roles/Form.tsx
var colorOptions = [
	{
		name: "Blue",
		value: "#2563EB"
...
function RoleForm({ role, permissions, isEdit }) {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		if (isEdit && role?.id) form.put(`/settings/roles/${role.id}`);
		else form.post("/settings/roles");
	};
	const togglePermission = (permissionId) => {
		const current = form.data.permissions;
		if (current.includes(permissionId)) form.setData("permissions", current.filter((id) => id !== permissionId));
		else form.setData("permissions", [...current, permissionId]);
	};
	const toggleGroup = (group) => {
		const groupPermissionIds = permissions[group]?.map((p) => p.id) || [];
		if (groupPermissionIds.every((id) => form.data.permissions.includes(id))) form.setData("permissions", form.data.permissions.filter((id) => !groupPermissionIds.includes(id)));
		else {
			const newPermissions = [...new Set([...form.data.permissions, ...groupPermissionIds])];
			form.setData("permissions", newPermissions);
		}
	};
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: isEdit ? "Edit Role" : "Add Role" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", { children: [
								...
								form.errors.display_name && /* @__PURE__ */ jsx("p", {
									className: "text-sm text-red-600 mt-1",
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								children: colorOptions.map((color) => /* @__PURE__ */ jsx("button", {
									type: "button",
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("label", {
									...
									children: [/* @__PURE__ */ jsx("input", {
										...
										children: "Set as default role for new users"
									})]
								})
							})
						]
				...
				/* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Select which permissions this role should have"
						}),
						Object.keys(permissions).length === 0 ? /* @__PURE__ */ jsxs("div", {
							className: "text-center py-8 text-theme-muted",
							children: [/* @__PURE__ */ jsx("p", { children: "No permissions available. Create some permissions first." }), /* @__PURE__ */ jsx(Link, {
							...
							className: "space-y-6",
							children: Object.entries(permissions).map(([group, groupPermissions]) => {
								const allSelected = groupPermissions.map((p) => p.id).every((id) => form.data.permissions.includes(id));
								return /* @__PURE__ */ jsxs("div", {
									className: "border border-theme rounded-xl p-4",
									children: [/* @__PURE__ */ jsxs("div", {
										className: "flex items-center justify-between mb-3",
										children: [/* @__PURE__ */ jsx("h4", {
											className: "font-medium text-theme-primary capitalize",
											children: group
										}), /* @__PURE__ */ jsx("button", {
											type: "button",
										...
										children: groupPermissions.map((permission) => /* @__PURE__ */ jsxs("label", {
											...
											children: [/* @__PURE__ */ jsx("input", {
												...
												children: [/* @__PURE__ */ jsx("p", {
													...
													className: "text-xs text-theme-muted font-mono truncate",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Link, {
						...
						children: form.processing ? "Saving..." : isEdit ? "Update Role" : "Create Role"
					})]
				})
			]
		})]
