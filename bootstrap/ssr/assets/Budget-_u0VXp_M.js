      ...
      /* @__PURE__ */ jsxs(Card, { padding: "none", children: [
        ...
        /* @__PURE__ */ jsxs(Table, { children: [
          /* @__PURE__ */ jsx(Table.Thead, { children: /* @__PURE__ */ jsxs(Table.Tr, { children: [
            ...
            /* @__PURE__ */ jsx(Table.Th, { align: "right", children: "Remaining" }),
          ...
          /* @__PURE__ */ jsx(Table.Tbody, { children: categories.map((category) => /* @__PURE__ */ jsxs(Table.Tr, { children: [
            ...
            /* @__PURE__ */ jsx(Table.Td, { align: "right", className: "font-medium text-theme-primary", children: formatCurrency(category.budget) }),
            /* @__PURE__ */ jsx(Table.Td, { align: "right", className: "text-accent-600 dark:text-accent-400", children: formatCurrency(category.spent) }),
            /* @__PURE__ */ jsx(Table.Td, { align: "right", className: "text-secondary-600 dark:text-secondary-400", children: formatCurrency(category.remaining) }),
            /* @__PURE__ */ jsx(Table.Td, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
