...
function ProjectsIndex({
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "active":
        return "bg-primary-50 dark:bg-primary-500/20 text-primary-700 dark:text-primary-400 border border-primary-200 dark:border-primary-500/30";
      case "completed":
        return "bg-secondary-50 dark:bg-secondary-500/20 text-secondary-700 dark:text-secondary-400 border border-secondary-200 dark:border-secondary-500/30";
      case "draft":
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { padding: "none", className: "overflow-hidden", children: [
        ...
        projects.data.length === 0 && /* @__PURE__ */ jsxs("div", { className: "p-12 text-center", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-500 dark:text-gray-400 mb-6", children: "Get started by creating your first project" }),
          /* @__PURE__ */ jsxs(
            Link,
            {
              href: "/projects/create",
