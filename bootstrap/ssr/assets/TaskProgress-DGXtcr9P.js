...
function TaskProgress({
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Task Progress Report" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: tasks.map((task) => /* @__PURE__ */ jsx(Card, { padding: "none", children: /* @__PURE__ */ jsxs("div", { className: "p-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4 mb-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1 flex-wrap", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/50 px-2 py-0.5 rounded", children: task.code }),
              /* @__PURE__ */ jsx("span", { className: `text-xs font-medium px-2 py-0.5 rounded ${getStatusBadge(task.status)}`, children: task.status_label }),
              /* @__PURE__ */ jsx("span", { className: `text-xs font-medium px-2 py-0.5 rounded ${getPriorityBadge(task.priority)}`, children: task.priority_label })
            ] }),
            /* @__PURE__ */ jsx("h3", { className: "font-medium text-theme-primary truncate", children: task.name }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-theme-muted", children: task.project_name })
          ] }),
          /* @__PURE__ */ jsx(
            Link,
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ jsx("span", { className: "text-theme-muted", children: "Target Achievement" }),
          /* @__PURE__ */ jsxs("span", { className: "font-medium text-theme-primary", children: [
            task.achieved,
            " / ",
            task.target,
      ...
      tasks.length === 0 && /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", { className: "p-12 text-center", children: [
        /* @__PURE__ */ jsx(ClipboardList, { className: "w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-4" }),
        /* @__PURE__ */ jsx("p", { className: "text-theme-secondary", children: "No tasks found" })
      ] }) })
    ] })
  ] });
}
export {
  TaskProgress as default
};
