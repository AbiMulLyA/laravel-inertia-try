...
function UserForm({ user, isEdit }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: isEdit ? "Edit User" : "Add User" }),
        ...
        /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-theme-primary", children: "User Information" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-theme-secondary", children: "Basic account details" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              form.errors.email && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 mt-1", children: form.errors.email })
            ] })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-theme-primary", children: "Role & Access" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-theme-secondary", children: "Assign user permissions" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "form-label", children: "Role" }),
            /* @__PURE__ */ jsx(
              "select",
              {
                ...
                className: "form-input",
                children: roleOptions.map((role) => /* @__PURE__ */ jsx("option", { value: role, children: role }, role))
              }
            ),
            form.errors.role && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 mt-1", children: form.errors.role })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-theme-primary", children: isEdit ? "Change Password" : "Set Password" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-theme-secondary", children: isEdit ? "Leave blank to keep current password" : "Create a secure password" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              form.errors.password && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 mt-1", children: form.errors.password })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
