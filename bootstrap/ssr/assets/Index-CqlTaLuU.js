...
//#region resources/js/Pages/Settings/Roles/Index.tsx
function RolesIndex({ roles, summary }) {
	const handleDelete = (role) => {
		...
		if (confirm(`Are you sure you want to delete "${role.display_name}"?`)) router.delete(`/settings/roles/${role.id}`);
	};
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: "Roles" }), /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: roles.map((role) => /* @__PURE__ */ jsx(Card, {
					padding: "none",
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										className: "text-xs text-theme-muted font-mono",
										children: role.name
									})] })]
								}), role.is_default && /* @__PURE__ */ jsx("span", {
									className: "px-2 py-0.5 bg-primary-100 dark:bg-primary-900/50 text-primary-700 dark:text-primary-300 text-xs font-medium rounded",
									children: "Default"
								})]
							}),
							role.description && /* @__PURE__ */ jsx("p", {
								className: "text-sm text-theme-secondary mb-4 line-clamp-2",
								children: role.description
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-4 text-sm text-theme-muted mb-4",
							...
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2 pt-3 border-t border-theme",
								children: [/* @__PURE__ */ jsxs(Link, {
									...
									children: [/* @__PURE__ */ jsx(Edit, { className: "w-4 h-4" }), "Edit"]
			...
			roles.length === 0 && /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" }), "Add First Role"]
					})
				]
			}) })
		]
