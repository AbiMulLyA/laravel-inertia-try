...
import { AlertCircle, ArrowRight, CheckCircle2, Clock, FolderKanban } from "lucide-react";
//#region resources/js/Pages/Reports/ProjectProgress.tsx
...
function ProjectProgress({ summary = {
	...
	at_risk: 0,
	completed: 0
}, projects = [], year = (/* @__PURE__ */ new Date()).getFullYear() }) {
	...
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: "Project Progress Report" }), /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [
			...
			/* @__PURE__ */ jsxs(Card, {
				...
				children: [
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx("span", {
													...
													className: `text-xs font-medium px-2 py-0.5 rounded ${getStatusBadge(project.status)}`,
													children: project.status_label
												})]
											}),
											/* @__PURE__ */ jsx("h3", {
											...
											/* @__PURE__ */ jsx("p", {
												...
												children: project.category_name
											})
										]
									}), /* @__PURE__ */ jsx(Link, {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
											...
											className: "font-medium text-theme-primary",
											children: formatCurrency(project.budget)
										})] }),
										/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
											className: "text-theme-muted",
											children: "Spent: "
					...
					projects.length === 0 && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(FolderKanban, { className: "w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-4" }), /* @__PURE__ */ jsx("p", {
							className: "text-theme-secondary",
...
//#endregion
export { ProjectProgress as default };
