...
import { ChevronLeft, ChevronRight, Edit, MoreHorizontal, Plus, Search, ShieldCheck, Trash2, UserPlus, Users } from "lucide-react";
import { useState } from "react";
//#region resources/js/Pages/Settings/Users/Index.tsx
function UsersIndex({ users, summary, filters }) {
	...
	const handleDelete = (user) => {
		if (confirm(`Are you sure you want to delete "${user.name}"?`)) router.delete(`/settings/users/${user.id}`);
	};
	...
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: "User Management" }), /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("form", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" }), /* @__PURE__ */ jsx("input", {
									type: "text",
						...
						children: /* @__PURE__ */ jsxs("table", {
							...
							children: [/* @__PURE__ */ jsx("thead", {
								...
								children: /* @__PURE__ */ jsxs("tr", { children: [
									/* @__PURE__ */ jsx("th", {
										className: "px-6 py-3 text-left text-xs font-semibold text-theme-secondary uppercase tracking-wider",
										children: "User"
									}),
									/* @__PURE__ */ jsx("th", {
										className: "px-6 py-3 text-left text-xs font-semibold text-theme-secondary uppercase tracking-wider",
									...
									/* @__PURE__ */ jsx("th", {
										className: "px-6 py-3 text-right text-xs font-semibold text-theme-secondary uppercase tracking-wider",
										children: "Actions"
									})
								] })
							}), /* @__PURE__ */ jsx("tbody", {
								...
								children: users.data.map((user) => /* @__PURE__ */ jsxs("tr", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("td", {
											className: "px-6 py-4",
											children: /* @__PURE__ */ jsx("span", {
												className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-100 dark:bg-primary-900/50 text-primary-700 dark:text-primary-300",
												children: user.role || "User"
											})
										}),
										/* @__PURE__ */ jsx("td", {
											className: "px-6 py-4",
											children: user.email_verified_at ? /* @__PURE__ */ jsx("span", {
												className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-secondary-100 dark:bg-secondary-900/50 text-secondary-700 dark:text-secondary-300",
												children: "Verified"
											}) : /* @__PURE__ */ jsx("span", {
										...
										/* @__PURE__ */ jsx("td", {
											className: "px-6 py-4 text-sm text-theme-secondary",
					...
					users.data.length === 0 && /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Link, {
								href: "/settings/users/create",
								className: "btn btn-primary",
								children: [/* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" }), "Add First User"]
							})
						]
					}),
					users.last_page > 1 && /* @__PURE__ */ jsxs("div", {
						className: "px-6 py-4 border-t border-theme flex items-center justify-between",
						children: [/* @__PURE__ */ jsxs("p", {
							...
							children: users.links.map((link, index) => {
								...
								if (link.label === "...") return /* @__PURE__ */ jsx("span", {
									className: "px-2 text-theme-muted",
