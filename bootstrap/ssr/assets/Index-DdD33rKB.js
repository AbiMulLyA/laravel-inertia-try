...
//#region resources/js/Pages/Categories/Index.tsx
...
function CategoriesIndex({ categories = [] }) {
	const handleDelete = (id, name) => {
		if (confirm(`Delete category "${name}"?`)) router.delete(`/categories/${id}`);
	};
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: "Categories" }), /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", {
						...
						children: categories.map((item) => /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								/* @__PURE__ */ jsx("td", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											className: "w-10 h-10 bg-gradient-to-br from-primary-100 to-primary-50 rounded-lg flex items-center justify-center border border-primary-200",
								...
								/* @__PURE__ */ jsx("td", {
									...
									children: item.total_projects
								}),
								/* @__PURE__ */ jsx("td", {
									className: "px-6 py-4 text-right text-gray-600",
									children: formatCurrency(item.total_budget)
								}),
								/* @__PURE__ */ jsx("td", {
									className: "px-6 py-4 text-center",
									children: /* @__PURE__ */ jsx("span", {
										className: `inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${item.is_active ? "bg-secondary-50 text-secondary-700 border border-secondary-200" : "bg-gray-100 text-gray-600 border border-gray-200"}`,
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Layers, { className: "w-8 h-8 text-gray-400" })
					}),
					/* @__PURE__ */ jsx("h3", {
					...
					/* @__PURE__ */ jsx("p", {
						...
						children: "Get started by adding your first category"
					}),
					/* @__PURE__ */ jsxs(Link, {
						href: "/categories/create",
						...
						children: [/* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" }), "Add Category"]
					})
				]
			})]
		})]
