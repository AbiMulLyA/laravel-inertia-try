...
//#region resources/js/Pages/Settings/Permissions/Form.tsx
function PermissionForm({ permission, groups, isEdit }) {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		if (isNewGroup && newGroup) form.setData("group", newGroup.toLowerCase());
		if (isEdit && permission?.id) form.put(`/settings/permissions/${permission.id}`);
		else form.post("/settings/permissions");
	};
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: isEdit ? "Edit Permission" : "Add Permission" }), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(Key, { className: "w-5 h-5 text-primary-600 dark:text-primary-400" })
							...
							children: "Define the permission identifier and settings"
						})] })]
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [
							/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsx("p", {
									...
									children: "Use dots to separate namespace (e.g., users.create, projects.delete)"
								}),
							...
							/* @__PURE__ */ jsxs("div", { children: [
								...
								isNewGroup ? /* @__PURE__ */ jsx("input", {
									...
									className: "form-input",
									children: [groups.length === 0 && /* @__PURE__ */ jsx("option", {
										value: "general",
										children: "general"
								...
								form.errors.group && /* @__PURE__ */ jsx("p", {
									className: "text-sm text-red-600 mt-1",
									children: form.errors.group
								})
							] })
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-end gap-3 mt-6 pt-6 border-t border-theme",
						children: [/* @__PURE__ */ jsx(Link, {
							href: "/settings/permissions",
							...
							children: form.processing ? "Saving..." : isEdit ? "Update Permission" : "Create Permission"
						})]
					})
				]
			}) })
...
//#endregion
export { PermissionForm as default };
