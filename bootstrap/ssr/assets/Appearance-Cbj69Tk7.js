...
//#region resources/js/Contexts/ThemeContext.tsx
...
function SettingsAppearance() {
	...
	return /* @__PURE__ */ jsxs(AppLayout, { children: [/* @__PURE__ */ jsx(Head, { title: "Appearance Settings" }), /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("p", {
						...
						children: "Select your preferred color scheme for the application."
					}),
					/* @__PURE__ */ jsx("div", {
						...
						children: themeOptions.map((option) => {
							...
							return /* @__PURE__ */ jsxs("button", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("h4", {
										className: `font-medium ${isSelected ? "text-primary-700 dark:text-primary-300" : "text-theme-primary"}`,
			...
			/* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("p", {
						className: "text-sm text-theme-secondary mb-6",
						children: "Inspired by Kabupaten Tasikmalaya brand colors."
					}),
					/* @__PURE__ */ jsx("div", {
						className: "space-y-4",
						children: colorPalette.map((color) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx("code", {
										className: "px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-sm font-mono text-theme-primary",
										children: color.hex
									})
								})
							]
...
//#endregion
export { SettingsAppearance as default };
