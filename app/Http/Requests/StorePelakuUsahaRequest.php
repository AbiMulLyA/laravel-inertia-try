...
class StorePelakuUsahaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nik' => ['required', 'string', 'size:16', 'unique:pelaku_usaha,nik'],
    ...
    public function messages(): array
    {
        return [
            ...
            'jumlah_ternak.integer' => 'Jumlah ternak harus berupa angka bulat.',
